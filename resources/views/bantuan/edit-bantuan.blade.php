...
@endpush
@section('content')
@section('title2','Form Edit Bantuan Dana Kelompok Tani')
        ...
        <div class="row">
          <div class="col-12">
            <div class="card">
                ...
                <h3 class="card-title">Edit Bantuan Dana kelompok Tani</h3>
              </div>
              ...
              <!-- /.card-header -->
                 ...
                 <div class="card-body">
                    ...
                    <form action="{{ url('update-bantuan', $peg->id) }}" method="post">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="kode_bantuan" name="kode_bantuan" class="form-control" placeholder="Kode Bantuan" value="{{$peg -> kode_bantuan}}">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="nama_bantuan" name="nama_bantuan" class="form-control" placeholder="Nama Bantuan" value="{{$peg -> nama_bantuan}}">
                        </div>
