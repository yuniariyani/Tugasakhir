...
@endpush
@section('content')
@section('title2','Form Tambah Cost Baseline')
        ...
        <div class="row">
          <div class="col-12">
            <div class="card">
                ...
                <h3 class="card-title">Edit detail anggaran biaya</h3>
              </div>
                 ...
                 <div class="card-body">
                    ...
                    <form action="{{ route('update-detailcost', $peg->id) }}" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="spesifikasi" name="spesifikasi" class="form-control" placeholder="Spesifikasi" value="{{$peg -> spesifikasi}}">
                        </div>
                        <div class="form-group">
